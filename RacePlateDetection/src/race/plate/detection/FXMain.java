...
//     private static final String DEFAULT_IMAGE_FILE_NAME = "/pic5.png";
    ...
    private static final String DEFAULT_IMAGE_FILE_NAME = "/bike4.jpg";
...
//                imageControl.applyProcessing(new BoundingBoxesAroundContoursAlgorithm());
                outputImages = imageControl.getOutputImageSequence();
    ...
    private ImageView buildInputImage() {
